    ...
    if curriculum_data:
        ...
        with st.expander("⚡ Quick Fill Subjects", expanded=has_templates):
            ...
            st.markdown(
                ...
                "<br>"
                "<b>Civil, Electrical & Electronics, VLSI, Electronics & Computer Engineering, and Electronics & Computer Science:</b> Sourced from official syllabus copies (not linked online)."
                "</small>", 
                unsafe_allow_html=True
            )
